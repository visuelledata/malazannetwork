...
remove_NAs <- function(df){
  df %>% 
    mutate(names = str_remove_all(names, "Mock"),
           names = str_remove_all(names, "Daughter "),
           names = str_remove_all(names, "Daughter"),
           names = str_remove_all(names, "Krafar"),
           ...
           names = str_replace_all(names, ";Onass;|Onass;|;Onass", ";"),
           names = str_replace_all(names, "Ordant Brid", "Ordantbrid"),
           names = str_replace_all(names, "Aren", ";"),
           names = str_replace_all(names, "Destriant", ";"),
           names = str_replace_all(names, "Goddess", ";"),
           names = str_replace_all(names, "Coral", ";"),
           names = str_replace_all(names, "^Wolves;|;Wolves$", ";"),
           names = str_replace_all(names, ";Brid|Brid;", ";"),
           names = str_replace_all(names, "Ordantbrid", "Ordant Brid"),
           ...
           names = str_replace_all(names, "K’risnan", ";"),
           names = str_replace_all(names, "Broken", ";"),
           names = str_replace_all(names, ";Shattered;|Shattered;|;Shattered", ";"),
           names = str_replace_all(names, ";Mistress;|Mistress;|;Mistress", ";"),
           names = str_replace_all(names, ";Chains;|Chains;|;Chains", ";"),
           names = str_replace_all(names, ";Crow;|Crow;|;Crow", ";"),
           names = str_replace_all(names, ";Warchief;|Warchief;|;Warchief", ";"),
           names = str_replace_all(names, "Corporal |Captain |Fist |Ceda |King |Commander |Queen |Hound |Lieutenant |High Mage |Master |Shield Anvil |Mortal Sword ", ";"),
...
standardize_names_net <- function(df){
  df %>% 
    mutate(names = str_replace_all(names, "Empress", "Laseen"), 
           ...
           names = str_replace_all(names, "Ganoes Stabro Paran|Ganoes Paran|Ganoes Stabro|Stabro Paran|Ganoes|Stabro|Paran|of the Deck", "Ganoes Stabro Paran"), 
           names = str_replace_all(names, "Korbolo Dom|Korbolo", "Korbolo Dom"),
           names = str_replace_all(names, "Anomander Rake|Rake|Purake|Anomandaris Purake|'Mander|Blacksword|Anomandaris Dragnipurake|Seguleh Seventh|Son of Darkness|Knight of High House Dark|Anomander", "Anomander Rake"), 
           names = str_replace_all(names, "Dujek Onearm|Dujek|Onearm", "Dujek Onearm"), 
           names = str_replace_all(names, "Quick Ben|Quick|Delat", "Ben Adaephon Delat"),
           ...
           names = str_replace_all(names, "Heboric Light Touch|
                                   Heboric Ghost Hands|Heboric|Ghost Hands|Light Touch", 
                                   "Heboric Light Touch"), 
           ...
           names = str_replace_all(names, "Silchas Ruin|Silchas|Ruin|White Crow", "Silchas Ruin"),
           ...
           names = str_replace_all(names, "Corabb Bhilan Thenu'alas Bhilan Thenu’alas|Corabb Bhilan Thenu'alas|Corabb Bhilan|Bhilan Thenu’alas|Corabb|Bhilan|Thenu'alas", "Corabb Bhilan Thenu'alas"),
           names = str_replace_all(names, "Councilman Turban Orr|Turban Orr|Turban", "Turban Orr"),
           names = str_replace_all(names, "Crump", "Jamber Bole"),
           ...
           names = str_replace_all(names, "Karsa Orlong|Karsa|Orlong", "Karsa Orlong"),
           ...
           names = str_replace_all(names, "Polielfrog|Poliel|Mistress of Pestilence|Grey|Queen of Disease", "Poliel"),
           names = str_replace_all(names, "T'riss|of Dreams|Queen of High House Life", "T'riss"),
           ...
           names = str_replace_all(names, "Cotillion|Dancer|Rope|Dorin|Assassin of High House Shadow", "Cotillion"),           names = str_replace_all(names, "Fist Gamet|Gamet|Gimlet", "Gamet"),
           names = str_replace_all(names, "Yan Tovis|Twilight", "Yan Tovis"),
           names = str_replace_all(names, "Rhulad Sengar|Rhulad", "Rhulad Sengar"),
           names = str_replace_all(names, "Tene Baralta|Tene|Baralta", "Tene Baralta"),
           ...
           names = str_replace_all(names, "Janath Anar|Janath|Anar", "Janath Anar"),
           names = str_replace_all(names, "Humbrall Taur|Humbrall|Taur", "Humbrall Taur"),
           names = str_replace_all(names, "Mallick Rel|Mallick", "Mallick Rel"),
           names = str_replace_all(names, "Blind Gallan|Gallan", "Blind Gallan"),
           names = str_replace_all(names, "Warleader Gall|Gall", "Warleader Gall"),
           names = str_replace_all(names, "Lieutenant Pores|Pores", "Pores"),
           names = str_replace_all(names, "Sukul Ankhadu|Ankhadu", "Sukul Ankhadu"),
           names = str_replace_all(names, "Kamist Reloe|Reloe|Kamist", "Kamist Reloe"),
           names = str_replace_all(names, "Warleader Mathok|Mathok", "Mathok"),
           names = str_replace_all(names, "Awl Torrent|Torrent", "Torrent"),
           names = str_replace_all(names, "Badan Gruk|Badan|Gruk", "Badan Gruk"),
           names = str_replace_all(names, "Buruk the Pale|Buruk", "Buruk the Pale"),
           names = str_replace_all(names, "Onrack T'emlava the|Onrack T'emlava", "Onrack T'emlava"),
           names = str_replace_all(names, "K’ell Hunter Sag’Churok", "Sag’Churok"),
           names = str_replace_all(names, "Setoc of the Wolves", "Setoc"),
           names = str_replace_all(names, "Sheltatha Lore|Lore", "Sheltatha Lore"),
           names = str_replace_all(names, "Matron Gunth’an Acyl|Gunth’an", "Gunth’an Acyl"),
           names = str_replace_all(names, "One Gunth Mach|Gunth Mach|Gunth", "Gunth Mach"),
           names = str_replace_all(names, "Bairoth Gild|Bairoth|Gild", "Bairoth Gild"),
           names = str_replace_all(names, "Samar Dev|Samar", "Samar Dev"),
           names = str_replace_all(names, "Triban Gnol Triban Gnol", "Triban Gnol"),
           names = str_replace_all(names, "Seba Krafar|Seba", "Seba Krafar"),
           names = str_replace_all(names, "Bruthen Trana|Bruthen|Trana", "Bruthen Trana"),
           names = str_replace_all(names, "Kuru Qan|Kuru", "Kuru Qan"),
           names = str_replace_all(names, "Ruthan Gudd|Ruthan|Gudd", "Ruthan Gudd"),
           names = str_replace_all(names, "Hull Beddict|Hull", "Hull Beddict"),
           names = str_replace_all(names, "Stonny Menackis|Stonny|Menackis", "Stonny Menackis"),
           names = str_replace_all(names, "Shurq Elalle|Elalle|Shurq", "Shurq Elalle"),
           names = str_replace_all(names, "Rud Shurq Elalle", "Rud Ellale"),
           names = str_replace_all(names, "Telorast and Curdle", "Curdle"),
           names = str_replace_all(names, "Pannion Seer|Pannion", "Pannion Seer"),
           names = str_replace_all(names, "Binadas Sengar|Binadas", "Binadas Sengar"),
           names = str_replace_all(names, "Uruth Sengar|Uruth", "Uruth Sengar"),
           names = str_replace_all(names, "Torvald Nom|Torvald", "Torvald Nom"),
           names = str_replace_all(names, "Sormo E’nath|Sormo|E’nath", "Sormo E'nath"),
           names = str_replace_all(names, "Riggalai the Seer|Riggalai|Rigga", "Rigga"),
